...
2. **Two named documents** that the nephew's 1972 testimony (325-113-2) says were
   ...
   German-language document of 16 June 1945 signed Dr Josef Morávek, Praha II,
   Vodičkova ("Lucerna").
3. **The signature of Jaroslav Holý's 1973 statement** — Humprecht's valet and
   driver. Hořejš quotes it from this same investigation; it is not in any unit
   eBadatelna has published.
4. **Whether more Gestapo Kolín units exist** beyond those published, naming
   Feustel, Meier, Wittiger, Horn and Laufka with their dates of birth.
5. **Procedure** — how to lodge a žádanka, whether remote access is possible,
   timescales and the reproduction tariff. Costs accepted.

It lists the eleven units already read so they do not repeat work we have done,
and says in terms that material unfavourable to the family is wanted too.
