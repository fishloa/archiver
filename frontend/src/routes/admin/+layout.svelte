<script lang="ts">
	...
	import { ShieldCheck, RefreshCw, Users, Activity, Clock, SlidersHorizontal, Cpu } from 'lucide-svelte';
	...
	const tabs = [
		...
		{ href: '/admin/models', labelKey: 'admin.tab.models' as const, icon: Cpu }
	];
