...
class ProcessorClient(_Base):
    ...
    def __init__(self, base_url: str, token: str, **kwargs):
        # **kwargs so options added to the base client reach it without every subclass
        # needing to be updated in lockstep.
        super().__init__(base_url, token, user_agent="pdf-worker/0.1", **kwargs)
